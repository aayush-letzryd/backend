...
-- Primary Key : dropoff_id (BIGINT / Standard Sequential Integer: 1, 2, 3...)
...
COMMENT ON COLUMN public.sheet_dropoffs.dropoff_id IS 'Standard sequential integer primary key (1, 2, 3...).';
