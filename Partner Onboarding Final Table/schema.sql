-- =============================================================================
-- LetzRyd Core Partner Onboarding (Final Master Table) - PostgreSQL Schema
-- =============================================================================
-- Target Database: postgres
-- Target Schema  : public
-- Source Tables  : sheet_driver_onboarding (Google Sheet) + july_form_onboarding (Portal Form)
-- Master Table   : public.core_partner_onboarding
-- Active View    : public.active_core_partner_onboarding
-- Host           : YOUR_DB_HOST_HERE:5432
-- Description    : Master Single Source of Truth for driver-partner onboarding.
--                  Features gapless sequential IDs via advisory lock 777111222,
--                  real-time bidirectional triggers, soft delete retention,
--                  and canonical partner ID enforcement.
-- =============================================================================
